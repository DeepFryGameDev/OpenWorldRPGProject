...
{
    [System.Serializable]
    public class ActiveEquipSlotInteraction : MonoBehaviour
    {
        [ReadOnly] public bool hasEquip;
        [ReadOnly] public int equipID;
        ...
        void UnEquip()
        {
            playerHero.Unequip((int)equip.equipmentSlot);
        ...
        void SetIcon()
        {
            switch (equip.equipmentSlot)
            {
                case EquipmentSlot.CHEST:
                    defaultIcon = Resources.Load<Sprite>("Sprites/frame_backgrounds/chest_background");
                    break;
                case EquipmentSlot.FEET:
                    defaultIcon = Resources.Load<Sprite>("Sprites/frame_backgrounds/boots_background");
                    break;
                case EquipmentSlot.HANDS:
                    defaultIcon = Resources.Load<Sprite>("Sprites/frame_backgrounds/gloves_background");
                    break;
                case EquipmentSlot.HEAD:
                    defaultIcon = Resources.Load<Sprite>("Sprites/frame_backgrounds/helm_background");
                    break;
                case EquipmentSlot.LEFTARM:
                    defaultIcon = Resources.Load<Sprite>("Sprites/frame_backgrounds/shield_background");
                    break;
                case EquipmentSlot.NECK:
                    defaultIcon = Resources.Load<Sprite>("Sprites/frame_backgrounds/neck_background");
                    break;
                case EquipmentSlot.RELIC:
                    defaultIcon = Resources.Load<Sprite>("Sprites/frame_backgrounds/skill_background");
                    break;
                case EquipmentSlot.RIGHTARM:
                    defaultIcon = Resources.Load<Sprite>("Sprites/frame_backgrounds/melee_background");
                    break;
                case EquipmentSlot.RING:
                    defaultIcon = Resources.Load<Sprite>("Sprites/frame_backgrounds/ring_background");
                    break;
                case EquipmentSlot.WRIST:
                    defaultIcon = Resources.Load<Sprite>("Sprites/frame_backgrounds/bracers_background");
                    break;
            }

            gameObject.transform.Find("Button/IconBG/Icon").GetComponent<Image>().sprite = defaultIcon;
        }
        ...
        void PreviewEquip(Equipment newEquip, BaseHero hero)
        {
            ...
            PreviewUpdateStats(hero, hero.equipment[(int)newEquip.equipmentSlot]);
        }

        void PreviewUpdateStats(BaseHero hero, Equipment equipToCheck)
        {
            #region preperation
        ...
        public BaseHero NewHeroForEquip(BaseHero hero)
        {
            ...
            copy.equipment[11] = NewEquipment(hero.equipment[11]);
            copy.equipment[12] = NewEquipment(hero.equipment[12]);
